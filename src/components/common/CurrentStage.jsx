...
const StyledCurrentStage = styled.div`
...
const CurrentStage = ({ stageIndex, stageLength }) => {
  const { resizedWidth, resizedHeight } = useSize();

  return (
    <StyledCurrentStage resizedWidth={resizedWidth} resizedHeight={resizedHeight}>
      {stageIndex} / {stageLength}
    </StyledCurrentStage>
  );
};
